...
if ENV:
    ...
    from ElinaRobot.config import Development as Config
...
telethn = TelegramClient("elina", API_ID, API_HASH)
pbot = Client("elinapbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from ElinaRobot.modules.helper_funcs.handlers import (
