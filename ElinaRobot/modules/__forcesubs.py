...
from ElinaRobot import DRAGONS as SUDO_USERS
from ElinaRobot import pbot
from ElinaRobot.modules.sql_extended import forceSubscribe_sql as sql
            ...
            if chat_member.restricted_by.id == (client.get_me()).id:
                try:
                    ...
                    client.answer_callback_query(
                        cb.id,
                        text=f"ᴊᴏɪɴ ᴏᴜʀ @{channel} ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴘʀᴇss 'ᴜɴᴍᴜᴛᴇ ᴍᴇ' button.",
                        show_alert=True,
                    )
            else:
                client.answer_callback_query(
            ...
            try:
                ...
                try:
                    sent_message = message.reply_text(
                        "ᴡᴇʟᴄᴏᴍᴇ {} 🙏 \n **ʏᴏᴜ ʜᴀᴠᴇɴᴛ ᴊᴏɪɴᴇᴅ ᴏᴜʀ @{} ᴄʜᴀɴɴᴇʟ ʏᴇᴛ** 😭 \n \nᴘʟᴇᴀsᴇ ᴊᴏɪɴ [ᴏᴜʀ ᴄʜᴀɴɴᴇʟ](https://t.me/{}) ᴀɴᴅ ʜɪᴛ ᴛʜᴇ **ᴜɴᴍᴜᴛᴇ ᴍᴇ** ʙᴜᴛᴛᴏɴ. \n \n ".format(
...
__help__ = """
*Force Subscribe:*
❍ Elina can mute members who are not subscribed your channel until they subscribe
